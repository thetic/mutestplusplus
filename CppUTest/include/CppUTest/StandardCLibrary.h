...
/* Must include this first to ensure the StandardC include in CppUTestConfig
 * still happens at the right moment */
#include "CppUTestConfig.h"
    ...
    #define STANDARDCLIBRARY_H_
        ...
        /* Sometimes the C++ library does an #undef in stdlib of malloc and
         * free. We want to prevent that */
        #ifdef __cplusplus
        ...
        /* Needed to ensure that string.h is included prior to strdup
         * redefinition */
        ...
        /*
         * #warning "These definitions in StandardCLibrary.h are pure (educated,
         * from linux kernel) guesses at the moment. Replace with your platform
         * includes." Not on as warning are as errors :P
         */
